...
AGE_PRESETS = PRESETS_DIR / "age"


class TestTransactionAttackers:
    def test_from_params(self):
        data = load_jsonlines(str(AGE_PRESETS / "sample.jsonl"))
                ...
                try:
                    params = Params.from_file(
                        ...
                        ext_vars={
                            "DATA_PATH": "",
                            "OUTPUT_PATH": "",
                            "CLF_PATH": str(AGE_PRESETS / "models/target_clf/gru_target_age.tar.gz"),
                            "MASKED_LM_PATH": str(AGE_PRESETS / "models/lm/lm.model.tar.gz"),
                        },
                    )
